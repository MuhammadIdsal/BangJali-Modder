...
tampilan() {
    ...
    allowed_ips_url="https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Modder/main/ip"
...
memasang_notifikasi_bot() {
  ...
  local izinsc="https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Modder/main/ip"
